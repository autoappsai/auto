        ...
        <>
            {typeof gcard !== 'undefined' && gcard.length <= 0 &&
                <motion.div
                    ...
                    className="col-span-1 p-[3px] shadow rounded-lg cursor-pointer duration-300 transition-all hover:scale-105" onClick={() => { getCard() }}>
                    <div className="bg-white rounded-lg min-h-[200px] flex items-center">
                        {!cardError ?
                            <div className="w-full text-center">
                                ...
                                {!loading &&
                                    <div className="w-full text-center mb-5">
                                        <img src="/img/generate_post.png" width="30" className="inline-block w-[40px]" />
                                    </div>
                                }
                                {!loading && typeof gcard !== 'undefined' && gcard.length <= 0 && (
                                    <button className="font-semibold">
                                        Generate a post for <span className="underline underline-offset-4">{card}</span>
                                    </button>
                                )
                                }
                                {loading &&
                            ...
                            <div className="w-full p-4 text-center">
                                ...
                                <p className="mb-1">There was an error retrieving the content. Please regenerate your post clicking the button below.</p>
                                <button className="font-semibold bg-black text-white px-4 py-2 rounded" onClick={() => { getCard() }}>
                                    Try Again
                                </button>
                            </div>
                        }
